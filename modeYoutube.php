                                            ...
                                            <div class="tab-pane" id="tabEmbed">
                                                ...
                                                <textarea class="form-control" style="min-width: 100%" rows="5" id="textAreaEmbed"><?php
                                                    if ($video['type'] == 'video' || $video['type'] == 'embed') {
                                                        $code = '<iframe width="640" height="360" style="max-width: 100%;max-height: 100%; border:none;" src="' . Video::getLink($video['id'], $video['clean_title'], true) . '" allow="fullscreen autoplay">iFrame is not supported!</iframe>';
                                                    } else {
                                                        $code = '<iframe width="350" height="40" style="max-width: 100%;max-height: 100%; border:none;" src="' . Video::getLink($video['id'], $video['clean_title'], true) . '" allow="fullscreen autoplay">iFrame is not supported!</iframe>';
                                                    }
